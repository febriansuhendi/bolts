...
WebUI.setText(findTestObject('bolt/Page_E-commerce Microservices Demo/input_e.g. ORD-003'), 'ORD-741')

WebUI.setText(findTestObject('bolt/Page_E-commerce Microservices Demo/input_Customer name'), 'Completed Order')
